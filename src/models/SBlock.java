    ...
    public void SetTopLeftPos(){
        ...
        {//arrow's tail is closest to the origin for pieces that aren't centered. pieces rotate about their origin
            ...
            case 1://to horiz 1 (←)
                ...
                4 3
                 */
                super.TopLeftPos.x = super.r4.getXLocation();
                super.TopLeftPos.y = super.r1.getYLocation();
                break;
            ...
            case 3://to horiz 2 (→)
                ...
                super.TopLeftPos.y = super.r3.getYLocation();
                break;
            default:
